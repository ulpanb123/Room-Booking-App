...
class UserReservationsFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = UserReservationsFragment()
    }

    private lateinit var viewModel: UserReservationsViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(UserReservationsViewModel::class.java)
